...
//         {
//           id: 1,
//           text: "Hi there! This is an AI assistent provide by the OZ media for your querries so , How can i help you today?",
//           sender: "bot",
//           timestamp: new Date(),
//         },
//       ]);
...
//         {
//           id: 1,
//           text: "Hi there! This is an AI assistant provided by OZ Media for your queries. How can I help you today?",
//           sender: "bot",
//           timestamp: new Date(),
//         },
//       ]);
...
//   return (
//     <div className="fixed bottom-26 lg:bottom-18 lg:right-6 md:bottom-30 md:right-6 right-4 z-50 font-[Outfit]">
//       <div
//         className={`w-14 h-14 bg-[#dcd4ff] rounded-full flex items-center justify-center cursor-pointer shadow-[4px_4px_0px_#000] border-2 border-black transition-all duration-300 hover:-translate-x-1 hover:-translate-y-1 hover:shadow-[6px_6px_0px_#000] ${
//           isOpen ? "scale-0" : "scale-100"
//         }`}
...
//               className="md:h-8 md:w-8 h-8 w-8 rounded-lg bg-black"
//             />
//             <h3 className="font-semibold text-black">Oz AI Assistant 🤖</h3>
//           </div>
//           <button
//             onClick={() => setIsOpen(false)}
...
//                 <button
//                   onClick={handleStartChat}
//                   className="w-full bg-[#dcd4ff] text-black py-2 rounded-lg font-semibold border-2 border-black shadow-[2px_2px_0px_#000] hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[3px_3px_0px_#000] transition-all text-sm"
//                 >
//                   Start Chat
//                 </button>
//               </div>
...
//                   >
//                     <div
//                       className={`max-w-[75%] px-3 py-2 rounded-lg animate-slideFade text-xs sm:text-sm leading-relaxed ${
//                         message.sender === "user"
//                           ? "bg-[#dcd4ff] rounded-br-none"
//                           : "bg-gray-100 rounded-bl-none"
//                       }`}
...
//                 {isTyping && (
//                   <div className="flex justify-start">
//                     <div className="bg-gray-100 px-3 py-2 rounded-lg rounded-bl-none max-w-[50%]">
//                       <div className="flex space-x-1">
//                         <span className="w-2 h-2 bg-gray-500 rounded-full animate-bounce"></span>
//                         <span className="w-2 h-2 bg-gray-500 rounded-full animate-bounce delay-150"></span>
//                         <span className="w-2 h-2 bg-gray-500 rounded-full animate-bounce delay-300"></span>
