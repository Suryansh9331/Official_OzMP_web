...
const OverviewSection = () => {
  return (
    <section className="bg-[#DBD2FF] py-12 px-4 md:px-16 flex flex-col md:flex-row items-center justify-between gap-10">
      {/* Left Image */}
      ...
      <div className="w-full md:w-[50%] space-y-6">
        ...
        {/* Description */}
        <p className="text-gray-700 text-md leading-relaxed" style={{ fontFamily: "Inter, sans-serif" }}>
        ...
        {/* Button */}
        <button
          className="text-sm mt-8 px-6 py-2 rounded-full text-black font-medium  hover:cursor-pointer hover:-translate-x-0.5 hover:-translate-y-0.5  transition-transform duration-300 shadow-[4px_4px_0px_#000]"
