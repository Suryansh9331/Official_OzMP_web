...
const HeroBanner = () => {
  return (
    <section
      className="w-full bg-[#DBD2FF]   md:p relative overflow-hidden px-4 lg:px-0 md:px-10 md:pb-6  lg:pb-28 lg:pr-12  shadow-[10px_12px_0px_rgb(0,0,0,0.6)] "
    ...
    >
      ...
      <div className="relative z-10 max-w-full mx-auto flex flex-col-reverse  md:flex-col-reverse  lg:flex-row items-center justify-between">
        {/* Left Text Section */}
        <div className="lg:w-1/2 md:w-full w-full mb-8 md:mb-0 lg:mx-12  lg:px-0  md:px-12  px-4 py-10 md:py-8 ">
          <h1
        ...
        {/* Right Image Section */}
        <div className="lg:w-1/2  w-full flex justify-center z-10 md:shadow-[10px_12px_0px_rgb(0,0,0,0.6)]   shadow-[8px_12px_0px_rgb(0,0,0,0.8)]">
          <video
            src={heroVideo}
            autoPlay
            loop
