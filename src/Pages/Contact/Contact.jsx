...
const ContactFormSection = () => {
  return (
    <section
      className="lg:min-h-screen h-auto flex flex-col lg:flex-row items-center lg:items-start justify-center gap-12 px-6 md:px-4 lg:px-16 py-12 bg-no-repeat bg-cover"
      style={{
        backgroundColor: "#DBD2FF",
        backgroundImage: `url(${bgImage})`,
      }}
    >
      ...
      <div className="w-full lg:w-1/2 space-y-6 text-center lg:text-left">
        <h1 className="text-3xl md:text-5xl lg:text-5xl font-bold font-['Archivo'] text-black leading-tight">
      ...
      {/* Right Contact Form */}
      <div className="w-full max-w-xl bg-white rounded-2xl shadow-[8px_8px_0px_0px_rgba(0,0,0,0.85)] px-6 md:px-10 py-10">
        <h2 className="text-xl md:text-2xl font-semibold font-['Archivo'] text-black mb-6 text-center">
        ...
        <form className="space-y-7   font-['Archivo']">
          ...
          <div className="text-center">
            <button
              type="submit"
              className="bg-[#DBD2FF] shadow-[4px_4px_0px_0px_black] text-black px-8 py-2 rounded-full mt-2"
            >
              SUBMIT
            </button>
          </div>
