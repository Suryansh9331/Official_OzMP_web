...
const TestimonialSlider = () => {
  ...
  return (
    <div className="px-4 py-12 bg-white text-center overflow-hidden">
      ...
      <div className="relative mt-10 w-full flex justify-center overflow-hidden">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 place-items-center"
          >
            {visibleTestimonials.map((t, index) => (
              <div
                key={index}
                className="bg-[#DBD2FE] w-full max-w-xs rounded-xl p-6 shadow-md text-left font-[Poppins] hover:shadow-xl transition-all duration-500 hover:scale-105"
              >
