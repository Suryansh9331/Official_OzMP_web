...
const LeftServiceSection = ({
  ...
  return (
    <section ref={ref} className="w-full lg:py-14 md:py-6 py-6 px-4 lg:px-10 md:px-4">
      <motion.div
        className="flex flex-col lg:flex-row md:flex-row sm:flex-col items-center lg:gap-0 md:gap-2 gap-6"
