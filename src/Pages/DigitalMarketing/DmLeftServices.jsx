...
//   return (
//     <section ref={ref} className="w-full lg:py-10 md:py-4 py-6 px-4 md:px-10">
//       <motion.div
//         className="flex flex-col-reverse lg:flex-row items-center lg:gap-0 md:gap-10 sm:gap-4 "
...
//         >
//           <img src={image} alt="seo-illustration" className=" lg:max-w-[90%] md:w-full mx-auto" />
//         </motion.div>
...
//           variants={itemVariants}
//         >
//           <h2 className="text-3xl md:text-5xl font-[Archivo] font-semibold text-[#0F0F3A] mb-8">
//             {heading}
//           </h2>
...
//             className="px-6 py-2 rounded-full font-medium font-[Inter] shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-md transition mt-6"
//           >
//             {buttonText}
//           </motion.button>
//         </motion.div>
...
const LeftServiceSection = ({
  ...
  return (
    <section ref={ref} className="w-full lg:py-10 md:py-6 py-6 px-4 lg:px-10 md:px-4">
      <motion.div
        className="flex flex-col-reverse lg:flex-row md:flex-row sm:flex-col-reverse items-center lg:gap-0 md:gap-2 gap-6"
        variants={containerVariants}
        initial="hidden"
        animate={inView ? "visible" : "hidden"}
      >
        ...
        {/* Right Content */}
        <motion.div
          className="w-full lg:w-1/2 md:w-[48%] text-left"
          variants={itemVariants}
        >
