...
const HeroBanner = () => {
  return (
    <>
      ...
      <section
        className="hidden lg:flex   h-[80vh] items-start bg-no-repeat bg-cover lg:py-20 md:py-16 py-12"
        style={{
      ...
      <section className="flex lg:hidden h-[70vh] items-center px-4 justify-center bg-[#DBD2FF]/40">
        <HeroContent />
      </section>
    </>
  );
