...
import { 
  CircleCheck, Palette, Monitor, Smartphone, Eye, Layers, Users, 
  BarChart3, Settings, Zap, Shield, ArrowRight, CheckCircle, 
  Paintbrush, MousePointer, Layout, Heart, Star, Globe, 
  Code, Database, Cloud, Lock, Brain, Workflow, Camera,
  Figma, Pen, Image, Square, Triangle, Circle, Play
} from "lucide-react";
...
const GraphicUIUXDesignPage = () => {
    ...
    const features = [
        ...
        },
        {
            ...
            title: "UI/UX Design",
            description: "User-centered interface designs that prioritize usability, accessibility, and conversion optimization for web and mobile platforms."
        },
        {
            icon: <Eye size={40} />,
            title: "Visual Design",
            description: "Stunning graphics, illustrations, and visual elements that communicate your message effectively across all marketing channels."
        },
        {
            icon: <MousePointer size={40} />,
            title: "Interactive Design",
            description: "Engaging interactive elements, animations, and micro-interactions that enhance user experience and drive engagement."
        }
    ];
    ...
    const processSteps = [
        {
            ...
            description: "Deep dive into your brand, target audience, competitors, and market trends to create design strategies that resonate and convert."
        },
        {
            step: "02",
            title: "Concept & Wireframing",
            description: "Creating initial concepts, wireframes, and user flow diagrams to establish the foundation for exceptional user experiences."
        },
        {
            step: "03",
            title: "Design & Prototyping",
            description: "Crafting pixel-perfect designs with interactive prototypes for testing and validation before final implementation."
        },
        {
            step: "04",
            title: "Testing & Refinement",
            description: "User testing, feedback incorporation, and design refinement to ensure optimal usability and visual appeal."
        }
    ];
    ...
    const designTypes = [
        {
            ...
            description: "Complete brand identity systems that establish strong brand recognition and emotional connection",
            longDescription: "Our brand identity designs go beyond just logos. We create comprehensive visual systems including color palettes, typography, imagery styles, and brand guidelines that ensure consistent brand communication across all touchpoints and marketing materials.",
            features: ["Logo Design", "Color Palette", "Typography", "Brand Guidelines", "Business Cards", "Letterheads"],
            benefits: ["85% brand recognition increase", "Consistent brand presence", "Professional credibility boost"],
            image: "https://mir-s3-cdn-cf.behance.net/project_modules/1400_webp/f4d11b222383449.67e4d3f6ab80f.jpg",
        ...
        },
        {
            ...
            description: "Comprehensive design systems that ensure consistent and intuitive user experiences across platforms",
            longDescription: "We create scalable design systems with reusable components, interaction patterns, and design tokens. Our UI/UX designs focus on user research, information architecture, and usability testing to deliver interfaces that users love and businesses benefit from.",
            features: ["User Research", "Wireframing", "Prototyping", "Design Systems", "Usability Testing", "Responsive Design"],
            benefits: ["40% increase in user engagement", "25% reduction in development time", "Improved user satisfaction"],
        ...
        },
        {
            ...
            description: "Eye-catching marketing materials and print designs that effectively communicate your message",
            longDescription: "From digital marketing assets to print materials, we create designs that capture attention and drive action. Our marketing designs are strategically crafted to align with your brand goals and target audience preferences while maintaining visual consistency.",
            features: ["Social Media Graphics", "Brochures", "Flyers", "Posters", "Web Banners", "Packaging Design"],
            benefits: ["60% higher engagement rates", "Professional brand image", "Increased conversion rates"],
            image: "https://assets.cdn.thewebconsole.com/S3WEB6795/images/Flyers-Category-Image-2021-7-31-12-06-04.jpg?m=01daaffde7ced686fd3c3f6faf79d1b7",
    ...
    const industries = [
        ...
        { 
            name: "Healthcare", 
            icon: "🏥", 
            description: "Clean, accessible designs for medical and healthcare applications",
            projects: "150+ Designs",
            color: "bg-green-100 hover:bg-green-200",
            image: "https://cdn.dribbble.com/userupload/4839041/file/original-d581fe65b968e5ca5b1b5630811db011.jpg?resize=752x&vertical=center"
        },
        { 
            name: "E-Commerce", 
            icon: "🛒", 
            description: "Conversion-focused designs for online stores and marketplaces",
            projects: "180+ Designs",
            color: "bg-orange-100 hover:bg-orange-200",
            image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQTTWSKuyABvcflwHBH6ckXxv_Z57PiXQBTQ&s"
        },
        { 
            name: "Finance", 
            icon: "💰", 
            description: "Trust-building designs for fintech and banking applications",
            projects: "120+ Designs",
            color: "bg-purple-100 hover:bg-purple-200",
            image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSp9eQH41eMfQ0syUSm5KaAr3Jwhfxpn4rw1Q&s"                      
        },
        { 
            name: "Education", 
            icon: "🎓", 
            description: "Engaging designs for e-learning platforms and educational tools",
            projects: "100+ Designs",
            color: "bg-yellow-100 hover:bg-yellow-200",
            image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT_DWMici7pxECVtSCGUD2Eq5MY3V2L3zZ22g&s"
        },
        { 
            name: "Real Estate", 
            icon: "🏢", 
            description: "Premium designs for property listings and real estate platforms",
            projects: "90+ Designs",
            color: "bg-pink-100 hover:bg-pink-200",
            image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT1ICDxJfIxbKGhghN9pDURq7VV2EYHMF2XAQ&s"
        }
    ];
    ...
    const testimonials = [
        {
            ...
            quote: "Their design transformed our user experience completely. Our app engagement increased by 70% after the redesign.",
            rating: 5,
        ...
        },
        {
            ...
            quote: "The brand identity they created perfectly captures our vision. Our brand recognition has improved dramatically.",
            rating: 5,
        ...
        },
        {
            name: "Sarah Davis",
            company: "E-Shop Pro",
            quote: "Outstanding design work! Our conversion rate increased by 45% with their new e-commerce design.",
            rating: 5,
            position: "CEO",
                                ...
                                <div className="space-y-4">
                                    <div className="bg-[#dcd4ff] p-4 rounded-2xl">
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-xs text-gray-600">Creative Suite</div>
                                            </div>
                                        </div>
                                        <div className="grid grid-cols-2 gap-2">
                                            <div className="bg-white p-2 rounded-lg text-center">
                                                <Palette size={14} className="mx-auto mb-1 text-purple-600" />
                                    ...
                                    <div className="bg-[#dcd4ff] p-4 rounded-2xl">
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-xs text-gray-600">Logo & Colors</div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="space-y-3">
                                        <div className="bg-white p-3 rounded-xl flex items-center gap-3 shadow-sm">
                                            ...
                                            <div>
                                                <div className="text-sm font-semibold">UI Components</div>
                                                <div className="text-xs text-gray-600">Buttons & Cards</div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="bg-white p-3 rounded-xl flex items-center gap-3 shadow-sm">
                                            ...
                                            <div>
                                                <div className="text-sm font-semibold">Interactive Design</div>
                                                <div className="text-xs text-gray-600">Hover Effects</div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="p-4 space-y-4">
                            <div className="bg-[#dcd4ff] p-4 rounded-xl">
                                <div className="flex items-center justify-between mb-3">
                                    ...
                                    <div className="bg-purple-600 text-white px-3 py-1 rounded-full text-xs">Premium</div>
                                </div>
                                <p className="text-sm text-gray-700">Creative solutions for modern brands</p>
                            </div>
                ...
                <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl sm:text-5xl font-bold text-black mb-6">
                            Design <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-blue-600">Excellence</span>
                        </h2>
                        <p className="text-gray-600 max-w-2xl mx-auto text-lg">
                            We create designs that not only look beautiful but also drive results and enhance user experiences
                        </p>
                    </div>
                        ...
                        <div className="space-y-8">
                            <div className="flex items-start gap-4 transition-transform duration-300 hover:scale-[1.02]">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700">
                                        Every design decision is backed by user research and testing, ensuring interfaces that are intuitive, accessible, and conversion-focused.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 transition-transform duration-300 hover:scale-[1.02]">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700">
                                        Cohesive visual identity systems that maintain brand recognition and trust across web, mobile, print, and digital marketing materials.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 transition-transform duration-300 hover:scale-[1.02]">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700">
                                        All designs are optimized for web performance with proper compression, responsive images, and efficient loading without compromising visual quality.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 transition-transform duration-300 hover:scale-[1.02]">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700">
                                        Strategic design elements that guide users toward desired actions, improving conversion rates and business outcomes through psychological design principles.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="w-full lg:w-[85%] relative z-10 flex flex-col lg:flex-row items-center min-h-screen px-4 sm:px-6 py-8">
                    ...
                    <div className="w-full lg:w-[55%] text-center lg:text-left">
                        ...
                        <p className="text-lg sm:text-xl text-gray-700 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                            We create stunning visuals and intuitive interfaces that reflect your brand identity and enhance user engagement through thoughtful design and strategic user experience.
                        </p>
                ...
                <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                            We combine creative excellence with strategic thinking to create designs that not only look beautiful but also drive business results.
                        </p>
                    </div>
            ...
            <div className="py-24 bg-gradient-to-br from-gray-50 to-purple-50">
                <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                            Comprehensive design services that cover every aspect of your brand's visual communication and user experience needs.
                        </p>
                    </div>
                    ...
                    <div className="space-y-32">
                        {designTypes.map((design, index) => (
                            <div key={design.id} className={`flex flex-col ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-12`}>
                                {/* Content Side */}
                                <div className="flex-1 space-y-6">
                                    ...
                                    <h3 className="text-3xl font-bold text-black">{design.title}</h3>
                                    <p className="text-lg text-gray-700 leading-relaxed">{design.longDescription}</p>
                                ...
                                <div className="flex-1">
                                    <div className="relative group">
                                        ...
                                        <div className="relative bg-white p-8 rounded-3xl shadow-2xl border-2 border-black">
                                            ...
                                            <div className="space-y-4">
                                                <div className="flex items-center justify-between">
                                                    <div className="text-sm font-semibold text-gray-600">Design Status</div>
                                                ...
                                                <div className="grid grid-cols-3 gap-4">
                                                    ...
                                                    <div className="text-center p-3 bg-gray-50 rounded-lg">
                                                        <div className="text-lg font-bold text-green-600">48hr</div>
            ...
            <div className="py-24 bg-white">
                <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                            Specialized design solutions across diverse industries with deep understanding of sector-specific design requirements and user expectations.
                        </p>
                    </div>
  ...
  />
                                    ...
                                    <div className="p-6 space-y-4">
                                        ...
                                        <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                                            <div className="flex items-center gap-2">
                                                <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                                                <span className="text-sm text-green-600 font-semibold">Active Projects</span>
                                            </div>
                                            <ArrowRight 
                                                size={20} 
                    ...
                    <div className="text-center mt-16">
                        <div className="inline-block bg-gradient-to-r from-purple-100 to-blue-100 p-8 rounded-3xl border-2 border-black shadow-[8px_8px_0px_#000]">
                            <h3 className="text-2xl font-bold text-black mb-4">Need Custom Design Solutions?</h3>
                            <p className="text-gray-700 mb-6 max-w-md mx-auto">Every industry has unique design requirements. Let's discuss how we can create tailored designs for your specific business needs.</p>
            ...
            <div className="py-24 bg-gray-50">
                <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                            We use industry-leading design tools and software to create professional, high-quality designs and user experiences.
                        </p>
                    </div>
            ...
            <div className="py-24 bg-white relative overflow-hidden">
                ...
                <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6 relative z-10">
                    <div className="text-center mb-20">
                        ...
                        <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                            A systematic approach ensuring exceptional design delivery from initial concept to final implementation and beyond.
                        </p>
                    </div>
                    ...
                    <div className="text-center mt-20">
                        <div className="bg-[#dcd4ff] text-black px-8 py-9 rounded-tr-[10px] rounded-bl-[10px] transition-all duration-300 shadow-[8px_8px_0px_#000] border border-black">
                            <h3 className="text-2xl font-bold mb-4">Ready to Start Your Design Project?</h3>
                            <p className="mb-6 text-black">Let's create stunning visuals and exceptional user experiences that elevate your brand and engage your audience!</p>
            ...
            <div className="py-24 bg-gradient-to-br from-purple-50 to-blue-50">
                <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                            Real results from businesses that transformed their brand presence and user engagement with our design solutions.
                        </p>
                    </div>
                            ...
                            <div key={index} className="group">
                                <div className="bg-white p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-purple-200 hover:-translate-y-2">
                                    ...
                                    <div className="inline-flex items-center gap-2 bg-[#dcd4ff] px-3 py-1 rounded-full mb-4">
                                        ...
                                        <span className="text-sm font-semibold text-black">{testimonial.projectType}</span>
                                    </div>
            ...
            <div className="py-24 bg-white">
                <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                            Experience the advantages of professional design that not only looks amazing but also drives measurable business results.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <div className="text-center p-6 group hover:bg-purple-50 rounded-2xl transition-colors duration-300">
                            ...
                            <h3 className="text-xl font-bold text-black mb-3">First Impression Impact</h3>
                            <p className="text-gray-700">Users form opinions about your brand within 50 milliseconds. Professional design ensures that first impression is positive and memorable.</p>
                        </div>
                        ...
                        <div className="text-center p-6 group hover:bg-purple-50 rounded-2xl transition-colors duration-300">
                            ...
                            <h3 className="text-xl font-bold text-black mb-3">Increased Conversions</h3>
                            <p className="text-gray-700">Good design can increase conversion rates by up to 200%. Strategic UI/UX improvements directly impact your bottom line.</p>
                        </div>
                        ...
                        <div className="text-center p-6 group hover:bg-purple-50 rounded-2xl transition-colors duration-300">
                            ...
                            <h3 className="text-xl font-bold text-black mb-3">Brand Recognition</h3>
                            <p className="text-gray-700">Consistent visual identity increases brand recognition by 80%, building trust and loyalty with your target audience.</p>
                        </div>
                        ...
                        <div className="text-center p-6 group hover:bg-purple-50 rounded-2xl transition-colors duration-300">
                            ...
                            <h3 className="text-xl font-bold text-black mb-3">User Experience</h3>
                            <p className="text-gray-700">Intuitive design reduces user frustration by 40% and increases engagement time, leading to better customer satisfaction.</p>
                        </div>
                        ...
                        <div className="text-center p-6 group hover:bg-purple-50 rounded-2xl transition-colors duration-300">
                            ...
                            <h3 className="text-xl font-bold text-black mb-3">Market Competitiveness</h3>
                            <p className="text-gray-700">Professional design gives you a competitive edge, helping you stand out in crowded markets and attract premium customers.</p>
                        </div>
                        ...
                        <div className="text-center p-6 group hover:bg-purple-50 rounded-2xl transition-colors duration-300">
                            ...
                            <h3 className="text-xl font-bold text-black mb-3">Faster Loading</h3>
                            <p className="text-gray-700">Optimized graphics and efficient design reduce loading times by 60%, improving SEO rankings and user retention rates.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
                        <div className="lg:w-1/2">
                            ...
                            <p className="text-lg text-purple-100 mb-8">
                                Whether you need a complete brand identity, stunning UI/UX design, or marketing materials that convert, our creative team is ready to bring your vision to life with exceptional design solutions.
                            </p>
                            ...
                            <div className="relative">
                                ...
                                <div className="relative bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20 shadow-2xl">
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h3 className="text-xl font-bold text-white">User-Focused</h3>
