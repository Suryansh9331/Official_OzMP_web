...
import { 
  CircleCheck, Server, Shield, Zap, Globe, Database, Cloud, 
  BarChart3, Settings, Monitor, Download, Star, Lock, Cpu, 
  ArrowRight, CheckCircle, PlayCircle, Heart, Bell, HardDrive,
  Wifi, Activity, Gauge, AlertTriangle, TrendingUp, Users,
  Code, Layers, Workflow, LineChart, Timer, Headphones
} from "lucide-react";
...
const HostingServerManagementPage = () => {
    ...
    const features = [
        {
            ...
            description: "Fully managed hosting solutions with 24/7 monitoring, automated backups, and expert technical support for optimal performance."
        },
        {
            icon: <Cloud size={40} />,
            title: "Cloud Infrastructure",
            description: "Scalable cloud hosting on AWS, Google Cloud, and Azure with auto-scaling capabilities and global CDN integration."
        },
        {
            icon: <Shield size={40} />,
            title: "Security Management",
            description: "Advanced security protocols including SSL certificates, DDoS protection, malware scanning, and regular security updates."
        },
        {
            icon: <Zap size={40} />,
            title: "Performance Optimization",
            description: "SSD storage, caching solutions, CDN integration, and performance monitoring for lightning-fast website loading speeds."
        }
    ];
    ...
    const processSteps = [
        {
            ...
            description: "Comprehensive analysis of your current hosting needs, traffic patterns, resource requirements, and growth projections for optimal server configuration."
        },
        {
            step: "02",
            title: "Server Setup & Configuration",
            description: "Professional server deployment with optimized configurations, security hardening, SSL installation, and performance tuning for your specific requirements."
        },
        {
            step: "03",
            title: "Migration & Testing",
            description: "Seamless website/application migration with zero downtime, comprehensive testing, and performance validation across all functionalities."
        },
        {
            step: "04",
            title: "Monitoring & Maintenance",
            description: "24/7 server monitoring, automated backups, security updates, performance optimization, and proactive issue resolution with expert support."
        }
    ];
    ...
    const hostingTypes = [
        {
            ...
            description: "Optimized hosting specifically designed for WordPress websites with automatic updates and security",
            longDescription: "Our managed WordPress hosting provides lightning-fast performance with specialized caching, automatic WordPress updates, daily backups, and advanced security features. Perfect for blogs, business websites, and e-commerce stores built on WordPress.",
            features: ["WordPress Optimization", "Automatic Updates", "Daily Backups", "SSL Certificate", "CDN Integration", "Expert Support"],
            benefits: ["3x faster loading speeds", "99.9% uptime guarantee", "Enhanced security protection"],
            image: "https://verpex.com/assets/uploads/images/blog/What-Is-Managed-WordPress-Hosting.webp?v=1665750849",
        ...
        },
        {
            ...
            description: "Scalable virtual private servers with dedicated resources for growing businesses",
            longDescription: "Cloud VPS hosting offers dedicated resources with the flexibility to scale instantly. Perfect for applications requiring consistent performance, custom configurations, and root access. Includes SSD storage, automated backups, and 24/7 monitoring.",
            features: ["Dedicated Resources", "Root Access", "SSD Storage", "Auto Scaling", "Load Balancers", "Monitoring Dashboard"],
            benefits: ["Guaranteed server resources", "Instant scalability", "Full server control"],
            image: "https://5.imimg.com/data5/EW/BC/LD/SELLER-69586808/cloud-vps-jpg.jpg",
        ...
        },
        {
            ...
            description: "High-performance dedicated servers for mission-critical applications and high-traffic websites",
            longDescription: "Dedicated servers provide maximum performance and security with exclusive hardware resources. Ideal for large-scale applications, high-traffic websites, and enterprises requiring complete server control and customization.",
            features: ["Exclusive Hardware", "Full Server Control", "Custom Configurations", "DDoS Protection", "24/7 Monitoring", "Hardware Replacement"],
            benefits: ["Maximum performance", "Complete security control", "Unlimited bandwidth"],
            image: "https://www.parallels.com/blogs/ras/app/uploads/2020/10/dedicated-server-bg.jpg",
    ...
    const services = [
        { 
            ...
            icon: "🌐", 
            description: "Fast, reliable hosting for static and dynamic websites with 99.9% uptime",
            projects: "500+ Sites",
            color: "bg-blue-100 hover:bg-blue-200",
            image: "https://www.knownhost.com/blog/wp-content/uploads/2020/02/Web-Hosting-Info-Graphic-1024x536.png.webp"
        },
        { 
            name: "E-commerce Hosting", 
            icon: "🛒", 
            description: "Secure hosting optimized for online stores with SSL and payment processing",
            projects: "150+ Stores",
            color: "bg-green-100 hover:bg-green-200",
            image: "https://www.ecommerceceo.com/wp-content/uploads/2019/07/ecommerce-hosting.jpg"
        },
        { 
            name: "Database Management", 
            icon: "💾", 
            description: "Professional database hosting and management with automated backups",
            projects: "200+ Databases",
            color: "bg-purple-100 hover:bg-purple-200",
            image: "https://blog.panoply.io/hs-fs/hubfs/database%20management%20main.jpg?width=1000&name=database%20management%20main.jpg"
        },
        { 
            name: "Email Hosting", 
            icon: "📧", 
            description: "Professional email hosting with custom domains and spam protection",
            projects: "300+ Domains",
            color: "bg-orange-100 hover:bg-orange-200",
            image: "https://www.hostinger.com/tutorials/wp-content/uploads/sites/2/2017/04/email-hosting.webp"
        },
        { 
            name: "Application Hosting", 
            icon: "⚡", 
            description: "Scalable hosting for web applications with auto-scaling and load balancing",
            projects: "100+ Apps",
            color: "bg-red-100 hover:bg-red-200",
            image: "https://www.cloudways.com/blog/wp-content/uploads/Application-Hosting.jpg"
        },
        { 
            name: "Backup & Recovery", 
            icon: "🔄", 
            description: "Automated backup solutions with instant recovery and disaster management",
            projects: "400+ Backups",
            color: "bg-cyan-100 hover:bg-cyan-200",
            image: "https://blog.storagecraft.com/wp-content/uploads/2020/03/backup-and-recovery.jpg"
        }
    ];
    ...
    const testimonials = [
        {
            ...
            quote: "Our website went from 5-second load times to under 2 seconds. The hosting optimization increased our conversion rate by 40%.",
            rating: 5,
            position: "CTO",
        ...
        },
        {
            ...
            quote: "The server management team handled our Black Friday traffic surge perfectly. Zero downtime during our biggest sales day.",
            rating: 5,
        ...
        },
        {
            ...
            quote: "HIPAA-compliant hosting with excellent security. Our patient data is safe and our systems are always running smoothly.",
            rating: 5,
    ...
    const ServerDashboard = () => {
                    ...
                    <div className="space-y-4">
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center gap-3 mb-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-green-100">Production Environment</p>
                                    </div>
                                </div>
                        ...
                        <div className="bg-white p-4 rounded-2xl shadow-lg">
                            <div className="flex items-center justify-between mb-3">
                                <h4 className="font-semibold text-sm text-gray-800">Server Metrics</h4>
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center gap-3 p-2 rounded-xl bg-blue-50">
                                    ...
                                    <div className="flex-1">
                                        <div className="flex items-center justify-between mb-1">
                                            <span className="text-sm font-medium text-gray-800">CPU Usage</span>
                                            <span className="text-xs text-blue-600 font-bold">{cpuUsage}%</span>
                                        </div>
                                        <div className="w-full bg-blue-200 rounded-full h-1.5">
                                            <div className="bg-blue-500 h-1.5 rounded-full transition-all duration-500" style={{width: `${cpuUsage}%`}}></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-3 p-2 rounded-xl bg-purple-50">
                                    ...
                                    <div className="flex-1">
                                        <div className="flex items-center justify-between mb-1">
                                            <span className="text-sm font-medium text-gray-800">Memory</span>
                                            <span className="text-xs text-purple-600 font-bold">{memoryUsage}%</span>
                                        </div>
                                        <div className="w-full bg-purple-200 rounded-full h-1.5">
                                            <div className="bg-purple-500 h-1.5 rounded-full transition-all duration-500" style={{width: `${memoryUsage}%`}}></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-3 p-2 rounded-xl bg-green-50">
                                    ...
                                    <div className="flex-1">
                                        <div className="flex items-center justify-between mb-1">
                                            ...
                                            <span className="text-xs text-green-600 font-bold">{diskUsage}%</span>
                                        </div>
                                        <div className="w-full bg-green-200 rounded-full h-1.5">
                                            <div className="bg-green-500 h-1.5 rounded-full transition-all duration-500" style={{width: `${diskUsage}%`}}></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="bg-gradient-to-br from-orange-100 to-orange-200 p-3 rounded-xl">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <span className="text-xs font-medium text-orange-800">Network</span>
                                </div>
                            ...
                            <div className="bg-gradient-to-br from-purple-100 to-purple-200 p-3 rounded-xl">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <span className="text-xs font-medium text-purple-800">Connections</span>
                                </div>
                                <div className="text-xl font-bold text-purple-800">{activeConnections.toLocaleString()}</div>
                ...
                content: (
                    <div className="space-y-4">
                        <div className="bg-gradient-to-r from-blue-500 to-purple-600 p-4 rounded-2xl text-white">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-blue-100">Real-time performance tracking</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            {[
                                { service: "Web Server", status: "Running", response: "45ms", icon: "🌐" },
                                { service: "Database", status: "Optimized", response: "12ms", icon: "💾" },
                                { service: "SSL Certificate", status: "Valid", response: "365 days", icon: "🔒" }
                            ].map((service, index) => (
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex-1">
                                            <div className="flex items-center justify-between">
                                                <span className="font-medium text-sm text-gray-800">{service.service}</span>
                        ...
                        <div className="bg-white p-4 rounded-2xl shadow-lg">
                            <h4 className="font-semibold text-sm text-gray-800 mb-3">Performance Alerts</h4>
                            <div className="space-y-2">
        ...
        useEffect(() => {
            const interval = setInterval(() => {
                ...
                setCpuUsage(prev => Math.max(20, Math.min(80, Math.round((prev + (Math.random() - 0.5) * 10) * 100) / 100)));
                // setMemoryUsage(prev => Math.max(30, Math.min(85, prev + (Math.random() - 0.5) * 8)));
                setMemoryUsage(prev => Math.max(30, Math.min(85, Math.round((prev + (Math.random() - 0.5) * 8) * 100) / 100)));
               
                
                // setDiskUsage(prev => Math.max(20, Math.min(60, prev + (Math.random() - 0.5) * 3)));
                setDiskUsage(prev => Math.max(20, Math.min(60, Math.round((prev + (Math.random() - 0.5) * 3) * 100) / 100)));
                // setNetworkTraffic(prev => Math.max(0.5, Math.min(3.0, prev + (Math.random() - 0.5) * 0.5)));
                setNetworkTraffic(prev => Math.max(0.5, Math.min(3.0, Math.round((prev + (Math.random() - 0.5) * 0.5) * 10) / 10)));
                // setActiveConnections(prev => Math.max(500, prev + Math.floor((Math.random() - 0.5) * 100)));

                setActiveConnections(prev => Math.max(500, prev + Math.floor((Math.random() - 0.5) * 1000)));
            }, 6000);
                            ...
                            <div className="absolute bottom-6 left-4 right-4">
                                <div className="bg-white/80 backdrop-blur-md rounded-2xl p-3 shadow-lg border border-white/20">
                                    <div className="flex justify-around items-center">
                                        {[
                                            { icon: <Monitor size={20} />, active: currentView === 0 },
                                            { icon: <Activity size={20} />, active: currentView === 1 },
                ...
                <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl sm:text-5xl font-bold text-black mb-6">
                            Complete <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-blue-600">Hosting Solutions</span>
                        </h2>
                        <p className="text-gray-600 max-w-2xl mx-auto text-lg">
                            We provide reliable, scalable, and secure hosting infrastructure that keeps your business online and performing at its best
                        </p>
                    </div>
                        ...
                        <div className="space-y-8">
                            <div className="flex items-start gap-4 transition-transform duration-300 hover:scale-[1.02]">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700">
                                        Professional server management team available around the clock for technical support, troubleshooting, and maintenance.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 transition-transform duration-300 hover:scale-[1.02]">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700">
                                        Enterprise-grade infrastructure with redundant systems, failover protection, and 24/7 monitoring to ensure your website stays online.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 transition-transform duration-300 hover:scale-[1.02]">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700">
                                        SSD storage, advanced caching, CDN integration, and optimized server configurations deliver exceptional loading speeds.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 transition-transform duration-300 hover:scale-[1.02]">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700">
                                        Multi-layer security with SSL certificates, DDoS protection, malware scanning, and regular security updates and patches.
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className={`absolute -left-8 w-48 h-64 bg-black rounded-2xl p-1 shadow-2xl transform transition-all duration-700 ${
                                    ...
                                    <div className="w-full h-full bg-gradient-to-br from-blue-100 to-cyan-100 rounded-xl flex items-center justify-center">
                                        <div className="text-center p-4">
                                            ...
                                            <div className="text-lg font-bold text-gray-800">Cloud Hosting</div>
                                            ...
                                            <div className="space-y-3">
                                                <div className="bg-[#dcd4ff] p-3 rounded-xl">
                                                    ...
                                                    <div className="grid grid-cols-2 gap-2">
                                                        ...
                                                        <div className="bg-white p-2 rounded-lg text-center">
                                                            <Zap size={14} className="mx-auto mb-1 text-blue-600" />
                                                ...
                                                <div className="space-y-2">
                                                    <div className="bg-white p-3 rounded-xl flex items-center gap-3 shadow-sm hover:shadow-md transition-shadow">
                                                        ...
                                                        <div>
                                                            <div className="text-sm font-semibold">Web Hosting</div>
                                                            <div className="text-xs text-gray-600">Production Server</div>
                                                        </div>
                                                    </div>
                                                    <div className="bg-white p-3 rounded-xl flex items-center gap-3 shadow-sm hover:shadow-md transition-shadow">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="text-xs text-gray-600">MySQL Server</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div className="w-full lg:w-[85%] relative z-10 flex flex-col lg:flex-row items-center min-h-screen px-4 sm:px-6 py-8">
                    ...
                    <div className="w-full lg:w-[55%] text-center lg:text-left">
                        ...
                        <p className="text-lg sm:text-xl text-gray-700 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                            Ensure your website or application stays online, fast, and secure with expert hosting and server support that scales with your business growth.
                        </p>
                ...
                <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                            We provide enterprise-grade hosting infrastructure with professional management to ensure optimal performance and security.
                        </p>
                    </div>
            ...
            <div className="py-24 bg-white">
                <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                            From shared hosting to dedicated servers, we provide scalable hosting solutions tailored to your business requirements and growth goals.
                        </p>
                    </div>
                    ...
                    <div className="space-y-32">
                        {hostingTypes.map((hosting, index) => (
                            <div key={hosting.id} className={`flex flex-col ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-12`}>
                                {/* Content Side */}
                                <div className="flex-1 space-y-6">
                                    ...
                                    <h3 className="text-3xl font-bold text-black">{hosting.title}</h3>
                                    <p className="text-lg text-gray-700 leading-relaxed">{hosting.longDescription}</p>
                                ...
                                <div className="flex-1">
                                    <div className="relative group">
                                        ...
                                        <div className="relative bg-white p-8 rounded-3xl shadow-2xl border-2 border-black">
                                            ...
                                            <div className="space-y-4">
                                                <div className="flex items-center justify-between">
                                                    <div className="text-sm font-semibold text-gray-600">Server Status</div>
                                                    <div className="flex items-center gap-2">
                                                        <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
            ...
            <div className="py-24 bg-gradient-to-br from-gray-50 to-purple-50">
                <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                            Comprehensive hosting and server management services to keep your digital infrastructure running smoothly and securely.
                        </p>
                    </div>
                                ...
                                <div className={`relative overflow-hidden rounded-3xl transition-all duration-500 ${
                                    ...
                                    <div className="p-6 space-y-4">
                                        ...
                                        <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                                            <div className="flex items-center gap-2">
                                                <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                                                <span className="text-sm text-green-600 font-semibold">Active Service</span>
                                            </div>
                                            <ArrowRight 
                                                size={20} 
                    ...
                    <div className="text-center mt-16">
                        <div className="inline-block bg-gradient-to-r from-purple-100 to-blue-100 p-8 rounded-3xl border-2 border-black shadow-[8px_8px_0px_#000]">
                            <h3 className="text-2xl font-bold text-black mb-4">Need Custom Hosting Solutions?</h3>
                            <p className="text-gray-700 mb-6 max-w-md mx-auto">Every business has unique hosting requirements. Let's discuss how we can create the perfect hosting environment for your specific needs.</p>
            ...
            <div className="py-24 bg-white">
                <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                            We leverage industry-leading hosting platforms and technologies to deliver reliable, scalable, and high-performance hosting solutions.
                        </p>
                    </div>
            ...
            <div className="py-24 bg-gray-50 relative overflow-hidden">
                ...
                <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6 relative z-10">
                    <div className="text-center mb-20">
                        ...
                        <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                            A systematic approach ensuring optimal hosting performance from initial setup to ongoing maintenance and support.
                        </p>
                    </div>
                    ...
                    <div className="text-center mt-20">
                        <div className="bg-[#dcd4ff] text-black px-8 py-9 rounded-tr-[10px] rounded-bl-[10px] transition-all duration-300 shadow-[8px_8px_0px_#000] border border-black">
                            <h3 className="text-2xl font-bold mb-4">Ready to Optimize Your Hosting?</h3>
                            <p className="mb-6 text-black">Let's discuss your hosting needs and create a reliable, scalable infrastructure that grows with your business!</p>
            ...
            <div className="py-24 bg-gradient-to-br from-purple-50 to-blue-50">
                <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                            Real results from businesses that transformed their online presence with our reliable hosting and server management solutions.
                        </p>
                    </div>
                            ...
                            <div key={index} className="group">
                                <div className="bg-white p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-purple-200 hover:-translate-y-2">
                                    ...
                                    <div className="inline-flex items-center gap-2 bg-[#dcd4ff] px-3 py-1 rounded-full mb-4">
                                        ...
                                        <span className="text-sm font-semibold text-black">{testimonial.uptime} Uptime</span>
                                    </div>
            ...
            <div className="py-24 bg-white">
                <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                            Experience the advantages of professional hosting management that ensures optimal performance, security, and reliability for your business.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <div className="text-center p-6 group hover:bg-purple-50 rounded-2xl transition-colors duration-300">
                            ...
                            <h3 className="text-xl font-bold text-black mb-3">Lightning Fast Loading</h3>
                            <p className="text-gray-700">Optimized servers with SSD storage and advanced caching deliver 3x faster loading speeds, improving user experience and SEO rankings.</p>
                        </div>
                        ...
                        <div className="text-center p-6 group hover:bg-purple-50 rounded-2xl transition-colors duration-300">
                            ...
                            <h3 className="text-xl font-bold text-black mb-3">Advanced Security</h3>
                            <p className="text-gray-700">Multi-layer security protection including SSL certificates, DDoS protection, and malware scanning keeps your data safe from threats.</p>
                        </div>
                        ...
                        <div className="text-center p-6 group hover:bg-purple-50 rounded-2xl transition-colors duration-300">
                            ...
                            <h3 className="text-xl font-bold text-black mb-3">99.9% Uptime</h3>
                            <p className="text-gray-700">Redundant infrastructure and proactive monitoring ensure your website stays online, minimizing business disruption and revenue loss.</p>
                        </div>
                        ...
                        <div className="text-center p-6 group hover:bg-purple-50 rounded-2xl transition-colors duration-300">
                            ...
                            <h3 className="text-xl font-bold text-black mb-3">Scalable Infrastructure</h3>
                            <p className="text-gray-700">Auto-scaling capabilities handle traffic spikes seamlessly, ensuring consistent performance during high-demand periods.</p>
                        </div>
                        ...
                        <div className="text-center p-6 group hover:bg-purple-50 rounded-2xl transition-colors duration-300">
                            ...
                            <p className="text-gray-700">Round-the-clock technical support from certified server administrators ensures rapid issue resolution and peace of mind.</p>
                        </div>
                        ...
                        <div className="text-center p-6 group hover:bg-purple-50 rounded-2xl transition-colors duration-300">
                            ...
                            <h3 className="text-xl font-bold text-black mb-3">Automated Backups</h3>
                            <p className="text-gray-700">Daily automated backups with instant recovery options protect your data and ensure business continuity in any scenario.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
                        <div className="lg:w-1/2">
                            ...
                            <p className="text-lg text-purple-100 mb-8">
                                Whether you need shared hosting, VPS, dedicated servers, or cloud infrastructure, our team is ready to provide reliable, scalable hosting solutions that grow with your business.
                            </p>
                                ...
                                <div className="relative bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20 shadow-2xl">
                                    <div className="flex items-center gap-4 mb-6">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-purple-100">24/7 monitoring & support</p>
                                        </div>
                                    </div>
