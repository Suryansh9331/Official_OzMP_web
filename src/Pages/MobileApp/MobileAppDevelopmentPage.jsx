  ...
  const features = [
    {
      ...
      title: "Native Apps",
      description:
        "High-performance native apps for iOS and Android with platform-specific features and optimal user experience.",
    },
    {
      icon: <Monitor size={40} />,
      title: "Cross-Platform",
      description:
        "React Native and Flutter apps that work seamlessly across multiple platforms with shared codebase.",
    },
    {
      icon: <Globe size={40} />,
      title: "Progressive Web Apps",
      description:
        "PWAs that combine the best of web and mobile apps with offline capabilities and app-like experience.",
    },
    {
      icon: <Shield size={40} />,
      title: "Secure Architecture",
      description:
        "Enterprise-grade security with encrypted data handling, secure APIs, and compliance with app store guidelines.",
    },
  ];
  ...
  const processSteps = [
    {
      ...
      description:
        "Deep understanding of your target audience, market research, feature planning, and technical architecture design for optimal user experience.",
    },
    {
      step: "02",
      title: "UI/UX Design",
      description:
        "Creating intuitive user interfaces with wireframing, prototyping, and visual design that follows platform-specific guidelines.",
    },
    {
      step: "03",
      title: "Development & Testing",
      description:
        "Agile development approach with continuous testing, performance optimization, and quality assurance across all target devices.",
    },
    {
      step: "04",
      title: "Launch & Maintenance",
      description:
        "App store submission, launch strategy, post-launch monitoring, updates, and ongoing technical support and feature enhancements.",
    },
  ];
  ...
  const appTypes = [
    {
      ...
      description:
        "Feature-rich shopping apps with seamless payment integration and personalized shopping experiences",
      longDescription:
        "Our e-commerce mobile apps provide a complete shopping solution with advanced features like AR try-ons, AI-powered recommendations, secure payment gateways, and real-time inventory management. Built for scalability to handle high traffic during sales events.",
      features: [
        "Product Catalog",
        "Shopping Cart",
        "Payment Gateway",
      ...
      image:
        "https://miro.medium.com/v2/resize:fit:1400/1*EjiVGqG-EhYUHQEi0m7IHg.png",
    ...
    },
    {
      ...
      longDescription:
        "Build vibrant social communities with our comprehensive social app development. Features include real-time chat, video calls, content sharing, social feeds, and advanced privacy controls. Perfect for building communities and fostering user engagement.",
      features: [
        "Real-time Chat",
        "Video Calling",
        "Content Sharing",
      ...
      benefits: [
        ...
        "5M+ messages processed daily",
        "Real-time communication",
      ],
      image:
        "https://mir-s3-cdn-cf.behance.net/project_modules/1400/081098176216013.64c10a8cce558.png",
    ...
    },
    {
      ...
      description:
        "HIPAA-compliant health apps with telemedicine, fitness tracking, and wellness monitoring features",
      longDescription:
        "Comprehensive healthcare solutions including telemedicine platforms, fitness tracking, appointment scheduling, and health monitoring. All apps are HIPAA-compliant with secure data handling and integration with wearable devices.",
      features: [
        "Telemedicine",
        "Health Tracking",
        "Appointment Booking",
      ...
      image:
        "https://cdn.dribbble.com/userupload/15287863/file/original-bddb99e62bb7dec9dcf60b7e64b4cda4.png?resize=752x&vertical=center",
  ...
  const industries = [
    {
      ...
      icon: "🛒",
      description:
        "Shopping apps with AR try-ons and seamless payment integration",
      projects: "45+ Apps",
      color: "bg-blue-100 hover:bg-blue-200",
      image:
        "https://cdn.dribbble.com/userupload/17496099/file/original-06a327465e373fa7d35ef9a86028900c.jpg?resize=752x&vertical=center",
    },
    {
      name: "Healthcare",
      icon: "🏥",
      description:
        "Telemedicine and health monitoring apps with HIPAA compliance",
      projects: "28+ Apps",
    ...
    },
    {
      ...
      icon: "💳",
      description:
        "Banking and fintech apps with biometric security and crypto features",
      projects: "32+ Apps",
      color: "bg-green-100 hover:bg-green-200",
      image:
        "https://cdn.dribbble.com/userupload/17432014/file/original-59f5e92ceaf7903c197336d214ebc6d3.png?format=webp&resize=400x300&vertical=center",
    },
    {
      name: "Food Delivery",
      icon: "🍔",
      description:
        "On-demand delivery apps with real-time tracking and multi-vendor support",
      projects: "25+ Apps",
      color: "bg-orange-100 hover:bg-orange-200",
      image:
        "https://cdn.dribbble.com/userupload/42825309/file/original-9d4ec93f3216e5b017cbe5e53393d17e.png?resize=752x&vertical=center",
    },
    {
      name: "Education",
      icon: "📚",
      description:
        "E-learning platforms with interactive content and progress tracking",
      projects: "38+ Apps",
      color: "bg-purple-100 hover:bg-purple-200",
      image:
        "https://www.creativefabrica.com/wp-content/uploads/2022/03/10/Online-Learning-Education-App-UX-UI-Graphics-26829117-1.jpg",
    },
    {
      name: "Travel",
      icon: "✈️",
      description:
        "Travel booking and navigation apps with offline maps and itinerary planning",
      projects: "22+ Apps",
      color: "bg-cyan-100 hover:bg-cyan-200",
      image:
        "https://cdn.dribbble.com/userupload/17169016/file/original-083b4e68f7271b4000c532ecdd134483.png?resize=400x300",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      quote:
        "Our e-commerce app increased mobile sales by 65%. The user experience is phenomenal and our customers love it.",
      rating: 5,
      position: "CEO",
      image:
    ...
    },
    {
      ...
      quote:
        "The telemedicine app transformed our patient care. HIPAA-compliant and incredibly user-friendly for both doctors and patients.",
      rating: 5,
    ...
    },
    {
      ...
      quote:
        "Our fitness app has 4.8-star rating on both app stores. The real-time tracking features are exactly what our users needed.",
      rating: 5,
      position: "Founder",
      image:
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              {[
                {
                  name: "Sarah Wilson",
                  message: "How's the app development going?",
                  time: "2m",
                  online: true,
                  avatar: "SW",
                },
              ...
              <div className="absolute top-12 left-2 right-2 z-30">
                <div className="bg-white/95 backdrop-blur-md text-gray-800 p-4 rounded-2xl shadow-2xl border border-white/20">
                  <div className="flex items-start gap-3">
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center text-white ${notifications[currentNotification].color} shadow-lg`}
                    >
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-1">
                        <span className="font-semibold text-sm">
                          {notifications[currentNotification].app}
                        </span>
                        <span className="text-xs text-gray-500">
        ...
        <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              We build stunning mobile experiences that captivate users and
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4 transition-transform duration-300 hover:scale-[1.02]">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Platform-specific apps built with Swift and Kotlin for
                    optimal performance, leveraging native device features and
              ...
              <div className="flex items-start gap-4 transition-transform duration-300 hover:scale-[1.02]">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    React Native and Flutter apps that work seamlessly across
                    multiple platforms with shared codebase, reducing
              ...
              <div className="flex items-start gap-4 transition-transform duration-300 hover:scale-[1.02]">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Web-based apps that provide native app-like experience with
                    offline capabilities, push notifications, and app store
                    distribution.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 transition-transform duration-300 hover:scale-[1.02]">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Complete app store submission process, ASO strategies,
                    launch campaigns, and post-launch analytics to maximize app
        ...
        <div className="w-full lg:w-[85%] relative z-10 flex flex-col lg:flex-row items-center min-h-screen px-4 sm:px-6 py-8">
          ...
          <div className="w-full lg:w-[55%] text-center lg:text-left">
            ...
            <p className="text-lg sm:text-xl text-gray-700 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              We design and develop mobile apps that not only look stunning but
              also deliver exceptional performance across iOS and Android
              platforms with engaging user experiences.
            </p>
        ...
        <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              ...
              design to create apps that drive engagement and business growth.
            </p>
          </div>
      ...
      <div className="py-24 bg-white">
        <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Specialized mobile applications designed to transform user
              experiences and drive business growth across industries.
            </p>
          </div>
      ...
      <div className="py-24 bg-gradient-to-br from-gray-50 to-purple-50">
        <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Specialized mobile app solutions across diverse industries with
              deep domain knowledge and proven expertise.
            </p>
          </div>
          ...
          <div className="text-center mt-16">
            <div className="inline-block bg-gradient-to-r from-purple-100 to-blue-100 p-8 rounded-3xl border-2 border-black shadow-[8px_8px_0px_#000]">
              ...
              <p className="text-gray-700 mb-6 max-w-md mx-auto">
                We develop mobile apps for all industries. Let's discuss how we
                can create the perfect app for your specific business needs.
              </p>
              <Link to="/projects-details">
      ...
      <div className="py-24 bg-white">
        <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              We leverage the latest mobile development technologies to build
      ...
      <div className="py-24 bg-gray-50 relative overflow-hidden">
        ...
        <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6 relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              A proven methodology ensuring successful app delivery from concept
          ...
          <div className="text-center mt-20">
            <div className="bg-[#dcd4ff] text-black px-8 py-9 rounded-tr-[10px] rounded-bl-[10px] transition-all duration-300 shadow-[8px_8px_0px_#000] border border-black">
              ...
              <p className="mb-6 text-black">
                Let's discuss your app idea and create something amazing that
      ...
      <div className="py-24 bg-gradient-to-br from-purple-50 to-blue-50">
        <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Real results from businesses that transformed their user
              engagement with our mobile app solutions.
            </p>
          </div>
                ...
                <div className="bg-white p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-purple-200 hover:-translate-y-2">
                  ...
                  <div className="inline-flex items-center gap-2 bg-[#dcd4ff] px-3 py-1 rounded-full mb-4">
                    ...
                    <span className="text-sm font-semibold text-black">
                      {testimonial.appDownloads} Downloads
                    </span>
                  </div>
      ...
      <div className="py-24 bg-white">
        <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Experience the advantages of mobile-first approach with apps that
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center p-6 group hover:bg-purple-50 rounded-2xl transition-colors duration-300">
              ...
              <p className="text-gray-700">
                Mobile apps see 3x higher engagement rates compared to mobile
                websites with push notifications and personalized experiences.
              </p>
            </div>
            ...
            <div className="text-center p-6 group hover:bg-purple-50 rounded-2xl transition-colors duration-300">
              ...
              <p className="text-gray-700">
                Native apps load 2-5x faster than mobile websites, providing
                superior user experience and reducing bounce rates.
              </p>
            </div>
            ...
            <div className="text-center p-6 group hover:bg-purple-50 rounded-2xl transition-colors duration-300">
              ...
              <p className="text-gray-700">
                Direct communication channel with users, achieving 90% open
                rates and driving repeat engagement and conversions.
              </p>
            </div>
            ...
            <div className="text-center p-6 group hover:bg-purple-50 rounded-2xl transition-colors duration-300">
              ...
              <p className="text-gray-700">
                Apps work offline, providing uninterrupted user experience and
            ...
            <div className="text-center p-6 group hover:bg-purple-50 rounded-2xl transition-colors duration-300">
              ...
              <p className="text-gray-700">
                Detailed user behavior tracking, conversion funnels, and
                actionable insights to optimize app performance and revenue.
              </p>
            </div>
            ...
            <div className="text-center p-6 group hover:bg-purple-50 rounded-2xl transition-colors duration-300">
              ...
              <p className="text-gray-700">
                Apps create stronger brand connection with 60% higher customer
                lifetime value compared to mobile web users.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="lg:w-1/2">
              ...
              <p className="text-lg text-purple-100 mb-8">
                Whether you need a native iOS/Android app or a cross-platform
                solution, our team is ready to bring your mobile app vision to
                life with cutting-edge technology and user-centric design.
              </p>
