  ...
  return (
    <div className="font-poppins text-black bg-white">
      ...
      <HeroSection
        ...
        subheading="Empowering therapists and individuals with a digital-first approach to mental wellness, backed by powerful tools and a calming experience."
        description=""
      ...
      <section className="py-20 px-4 md:px-20 bg-white">
        <div className="transform transition-all duration-500 ease-out opacity-0 translate-y-4 animate-[fadeInUp_0.6s_0.4s_ease-out_forwards]">
          ...
          <p className="text-gray-700 text-lg font-[Poppins] mb-8">
            InspireWell is a robust mental wellness SaaS platform tailored for
            therapists and individuals navigating personal growth, mental health
            improvement, and habit building. The platform allows users to track
            their moods, engage in guided journaling powered by AI, schedule
            therapy sessions, and access insights through smart analytics — all
            from a clean, secure dashboard.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-10 mb-16">
            ...
            <div className=" bg-[#DBD2FF] border-2 border-black rounded-tl-4xl rounded-br-4xl rounded-tr-none rounded-bl-none p-6  transform transition-all duration-300 hover:translate-y-[-2px] shadow-[8px_8px_0px_rgb(0,0,0,0.8)] ">
              ...
              <p className="text-gray-600 font-[Poppins] text-sm">
                <strong>React</strong> for responsive SPA,{" "}
                <strong>Laravel</strong> for secure back-end API,{" "}
                <strong>MongoDB</strong> for flexible document storage, and
          ...
          <div className="mb-16 transform transition-all duration-300 hover:translate-y-[-1px]">
            ...
            <p className="text-gray-700 font-[Poppins]">
              Traditional therapy tools lacked personalization and digital
              accessibility. InspireWell bridges this gap by providing a
              holistic mental wellness platform, enabling users to actively
              participate in their mental growth and therapists to monitor
              progress remotely with clarity and care.
            </p>
          </div>
          ...
          <div className="mb-16 transform transition-all duration-300 hover:translate-y-[-1px]">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-gray-700 font-[Poppins]">
                  Ensuring trust and safety for users was the top priority. We
                  incorporated calming UI elements, rigorous data validation,
                  and encryption strategies to safeguard sensitive mental health
                  records.
                </p>
              </div>
              <div className="flex items-start gap-3">
                ...
                <p className="text-gray-700 font-[Poppins]">
                  Laravel's validation layer, paired with MongoDB's encryption
                  and an intuitive UI powered by React, helped us deliver a
                  scalable and secure experience across all devices.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-16 transform transition-all duration-300 hover:translate-y-[-1px]">
            ...
            <p className="text-gray-700 font-[Poppins]">
              InspireWell is now utilized by over 150+ wellness professionals
              across the globe. Feedback highlights its engaging AI journaling,
              ease of use, and the client insights it offers. With a responsive
              and intuitive interface, InspireWell elevates how digital therapy
              works.
            </p>
          </div>
