...
import sampleVideo from "../../assets/Video/Project6.mp4";
...
const RentRoam = () => {
  return (
    <div>
      <HeroSection
        heading={<>RentRoam – Real Estate Rental Platform</>}
        subheading="RentRoam is an advanced property rental marketplace allowing agents and users to list, filter, and book properties in real-time. It includes map integration, user messaging, and landlord dashboards."
        description=""
