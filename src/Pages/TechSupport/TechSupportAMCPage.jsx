...
import { 
  CircleCheck, Shield, Clock, Settings, AlertTriangle, CheckCircle, 
  Phone, Mail, MessageCircle, Zap, Users, BarChart3, Monitor, 
  Server, Database, Cloud, Lock, ArrowRight, Eye, Bell, 
  Activity, Cpu, HardDrive, Wifi, Battery, RefreshCw,
  Wrench, HeadphonesIcon, FileText, TrendingUp, AlertCircle,
  Star, Globe, Code, Layers, Heart, Download
} from "lucide-react";
...
const TechSupportAMCPage = () => {
    ...
    const features = [
        {
            icon: <Clock size={40} />,
            title: "24/7 Support",
            description: "Round-the-clock technical assistance with guaranteed response times to ensure your systems are always operational."
        },
        {
            icon: <Shield size={40} />,
            title: "Proactive Monitoring",
            description: "Continuous system monitoring with automated alerts and preventive maintenance to avoid issues before they occur."
        },
        {
            icon: <Wrench size={40} />,
            title: "Regular Maintenance",
            description: "Scheduled updates, patches, and optimizations to keep your systems running at peak performance and security."
        },
        {
            icon: <FileText size={40} />,
            title: "Detailed Reporting",
            description: "Comprehensive monthly reports with system performance metrics, security assessments, and improvement recommendations."
        }
    ];
    ...
    const processSteps = [
        {
            ...
            description: "Comprehensive evaluation of your current IT infrastructure, identifying potential issues, vulnerabilities, and optimization opportunities."
        },
        {
            step: "02",
            title: "Support Plan Setup",
            description: "Customized support plan creation with defined SLAs, response times, and maintenance schedules tailored to your business needs."
        },
        {
            step: "03",
            title: "Proactive Monitoring",
            description: "24/7 system monitoring implementation with automated alerts, performance tracking, and preventive maintenance protocols."
        },
        {
            step: "04",
            title: "Ongoing Support & Reports",
            description: "Continuous technical support with regular performance reports, security updates, and strategic IT recommendations for growth."
        }
    ];
    ...
    const serviceTypes = [
        {
            ...
            description: "Round-the-clock technical assistance for all your IT issues and questions",
            longDescription: "Our 24/7 help desk provides immediate technical support through multiple channels including phone, chat, and email. Our certified technicians are available around the clock to resolve issues, answer questions, and provide guidance on IT-related matters with guaranteed response times.",
            features: ["Phone Support", "Live Chat", "Email Tickets", "Remote Assistance", "Priority Queuing", "Escalation Management"],
            benefits: ["< 5 min response time", "99.9% availability", "Multi-language support"],
        ...
        },
        {
            ...
            description: "Continuous monitoring and maintenance to prevent issues before they impact your business",
            longDescription: "Our proactive monitoring service uses advanced tools to continuously watch your systems, networks, and applications. We identify potential issues before they become problems, perform automated maintenance tasks, and provide detailed insights into system performance and health.",
            features: ["Real-time Monitoring", "Automated Alerts", "Performance Analytics", "Capacity Planning", "Security Scanning", "Health Reports"],
            benefits: ["95% issue prevention", "Zero downtime goal", "Automated responses"],
    ...
    const testimonials = [
        {
            ...
            quote: "Their proactive monitoring prevented 3 major system failures last month. Our uptime improved from 97% to 99.8%.",
            rating: 5,
        ...
        },
        {
            ...
            quote: "Response time is incredible. When we have issues, they're resolved within minutes, not hours. Game changer for our business.",
            rating: 5,
        ...
        },
        {
            ...
            quote: "Monthly reports give us clear insights into our IT performance. Their recommendations have saved us thousands in potential upgrades.",
            rating: 5,
    ...
    const SupportDashboard = () => {
        ...
        const alerts = [
            { type: "info", message: "System backup completed successfully", time: "2m ago", icon: <CheckCircle size={14} />, color: "bg-green-500" },
            { type: "warning", message: "Server CPU usage at 75%", time: "5m ago", icon: <AlertTriangle size={14} />, color: "bg-yellow-500" },
            { type: "success", message: "Security patch installed", time: "10m ago", icon: <Shield size={14} />, color: "bg-blue-500" },
            { type: "info", message: "Monthly performance report ready", time: "1h ago", icon: <FileText size={14} />, color: "bg-purple-500" }
        ];
        ...
        useEffect(() => {
            ...
            const dataInterval = setInterval(() => {
                setActiveTickets(prev => Math.max(0, prev + Math.floor(Math.random() * 3) - 1));
                    ...
                    <div className="w-full h-full bg-black rounded-[2.5rem] overflow-hidden relative">
                        ...
                        <div className="pt-10 px-4 h-full bg-gradient-to-br from-gray-50 to-blue-50 relative">
                            <div className="flex justify-between items-center mb-6 text-xs text-gray-800">
                                ...
                                <div className="flex items-center gap-2">
                                    <div className="flex items-center gap-1">
                                        <div className={`w-2 h-2 rounded-full ${systemStatus === 'online' ? 'bg-green-500' : 'bg-red-500'} animate-pulse`}></div>
                                ...
                                <div className="space-y-4">
                                    <div className="bg-gradient-to-r from-purple-500 to-blue-600 p-4 rounded-2xl text-white shadow-xl overflow-hidden relative">
                                        ...
                                        <div className="relative z-10">
                                            <div className="flex items-center gap-3 mb-3">
                                                ...
                                                <div>
                                                    <h3 className="font-bold text-base">Support Center</h3>
                                                    <p className="text-xs text-purple-100">24/7 Technical Support</p>
                                                </div>
                                            </div>
                                            <div className="grid grid-cols-3 gap-2 mt-4">
                                                <div className="bg-white/15 backdrop-blur-sm p-2 rounded-lg text-center">
                                                    <div className="text-lg font-bold">{uptime.toFixed(1)}%</div>
                                                    <div className="text-xs text-purple-100">Uptime</div>
                                                </div>
                                                <div className="bg-white/15 backdrop-blur-sm p-2 rounded-lg text-center">
                                                    <div className="text-lg font-bold">{responseTime}m</div>
                                                    <div className="text-xs text-purple-100">Response</div>
                                                </div>
                                                <div className="bg-white/15 backdrop-blur-sm p-2 rounded-lg text-center">
                                                    <div className="text-lg font-bold">{activeTickets}</div>
                                    ...
                                    <div className="bg-white p-4 rounded-2xl shadow-lg">
                                        <div className="flex items-center justify-between mb-3">
                                            <h4 className="font-semibold text-sm text-gray-800">System Status</h4>
                                            <div className="flex items-center gap-1">
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex items-center gap-3 p-2 rounded-xl bg-green-50">
                                                ...
                                                <div className="flex-1">
                                                    <div className="text-sm font-medium text-gray-800">Web Servers</div>
                                                    <div className="text-xs text-green-600">Running Smoothly</div>
                                    ...
                                    <div className="bg-white p-4 rounded-2xl shadow-lg">
                                        <div className="flex items-center justify-between mb-3">
                                            <h4 className="font-semibold text-sm text-gray-800">Recent Alerts</h4>
                                            <Bell size={16} className="text-gray-400" />
                                        </div>
                                        <div className="space-y-2">
                                            <div className="flex items-start gap-3 p-2 rounded-lg bg-gray-50">
                                                <div className={`w-6 h-6 rounded-full flex items-center justify-center text-white ${alerts[currentAlert].color}`}>
                                                    {alerts[currentAlert].icon}
                                                </div>
                                                <div className="flex-1">
                                                    <div className="text-xs font-medium text-gray-800">{alerts[currentAlert].message}</div>
                                                    <div className="text-xs text-gray-500">{alerts[currentAlert].time}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="bg-white/80 backdrop-blur-md rounded-2xl p-3 shadow-lg border border-white/20">
                                    <div className="flex justify-around items-center">
                                        {[
                                            ...
                                            { icon: <HeadphonesIcon size={20} />, active: false, badge: activeTickets > 0 }
                                        ].map((item, index) => (
                                            <div key={index} className="relative">
                                                ...
                                                {item.badge && activeTickets > 0 && (
                                                    <div className="absolute -top-1 -right-1 w-4 h-4 bg-red-500 rounded-full flex items-center justify-center">
                                                        <span className="text-xs text-white font-bold">{activeTickets}</span>
                                                    </div>
                                                )}
                                            </div>
                                        ))}
                ...
                <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl sm:text-5xl font-bold text-black mb-6">
                            Complete <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-blue-600">Support Solutions</span>
                        </h2>
                        <p className="text-gray-600 max-w-2xl mx-auto text-lg">
                            Comprehensive technical support and maintenance services that keep your systems running smoothly
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div className="space-y-8">
                            <div className="flex items-start gap-4 transition-transform duration-300 hover:scale-[1.02]">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700">
                                        Round-the-clock technical assistance through phone, chat, email, and remote access with guaranteed response times and escalation procedures.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 transition-transform duration-300 hover:scale-[1.02]">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700">
                                        Continuous monitoring of your IT infrastructure with automated alerts, performance tracking, and preventive maintenance to avoid downtime.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 transition-transform duration-300 hover:scale-[1.02]">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700">
                                        Scheduled maintenance windows, security patches, software updates, and system optimizations to ensure peak performance and security.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 transition-transform duration-300 hover:scale-[1.02]">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700">
                                        Detailed monthly reports with system performance metrics, security assessments, and strategic recommendations for continuous improvement.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="relative">
                            <div className="relative flex items-center justify-center min-h-[420px]">
                                ...
                                <div className={`absolute -left-8 w-32 h-32 bg-gradient-to-br from-green-100 to-green-200 rounded-2xl p-4 shadow-2xl transform transition-all duration-700 ${
                                    activeService === 'monitoring' 
                                        ? '-top-4 rotate-12 opacity-100 z-20 scale-110' 
                                        : 'top-8 rotate-6 opacity-70 z-10 scale-100'
                                }`}>
                                    <div className="text-center h-full flex flex-col justify-center">
                                        <Activity size={40} className="text-green-600 mx-auto mb-2" />
                                        <div className="text-sm font-bold text-gray-800">Monitoring</div>
                                        <p className="text-xs text-gray-600 mt-1">24/7 Watch</p>
                                    </div>
                                </div>
                                
                                {/* Main Support Dashboard */}
                                <div className={`w-56 h-80 bg-white rounded-3xl p-4 shadow-2xl border-2 border-gray-200 transition-all duration-700 ${
                                    ...
                                    <div className="text-center space-y-4">
                                        ...
                                        <h3 className="font-bold text-lg text-gray-800">Help Desk</h3>
                                        <div className="space-y-3">
                                            <div className="bg-[#dcd4ff] p-3 rounded-xl">
                                                ...
                                                <div className="text-xs text-gray-600">Response: &lt; 5 min</div>
                                            </div>
                                            <div className="grid grid-cols-2 gap-2">
                                                <div className="bg-gray-50 p-2 rounded-lg text-center">
                                                    <Phone size={16} className="mx-auto mb-1 text-purple-600" />
                                                    <span className="text-xs">Call</span>
                                                </div>
                                                <div className="bg-gray-50 p-2 rounded-lg text-center">
                                                    <MessageCircle size={16} className="mx-auto mb-1 text-purple-600" />
                                ...
                                {/* Maintenance Service */}
                                <div className={`absolute -right-6 w-28 h-36 bg-gradient-to-br from-blue-100 to-blue-200 rounded-2xl p-3 shadow-2xl transform transition-all duration-700 ${
                ...
                <div className="w-full lg:w-[85%] relative z-10 flex flex-col lg:flex-row items-center min-h-screen px-4 sm:px-6 py-8">
                    ...
                    <div className="w-full lg:w-[55%] text-center lg:text-left">
                        ...
                        <p className="text-lg sm:text-xl text-gray-700 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                            Stay worry-free with dedicated IT support and proactive system maintenance. Our expert team ensures your technology works seamlessly, so you can focus on growing your business.
                        </p>
                ...
                <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                            We combine proactive monitoring with responsive support to ensure your systems are always running at peak performance.
                        </p>
                    </div>
            ...
            <div className="py-24 bg-white">
                <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                            From immediate technical assistance to proactive system maintenance, we provide complete IT support solutions tailored to your business needs.
                        </p>
                    </div>
                                        ...
                                        <div className="relative bg-white p-8 rounded-3xl shadow-2xl border-2 border-black">
                                            ...
                                            <div className="space-y-4">
                                                <div className="flex items-center justify-between">
                                                    <div className="text-sm font-semibold text-gray-600">Service Status</div>
                                                    <div className="flex items-center gap-2">
            ...
            <div className="py-24 bg-gradient-to-br from-gray-50 to-purple-50">
                <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                            Specialized technical support across diverse industries with deep understanding of sector-specific IT requirements and compliance needs.
                        </p>
                    </div>
                                ...
                                <div className={`relative overflow-hidden rounded-3xl transition-all duration-500 ${
                                    ...
                                    <div className="p-6 space-y-4">
                                        ...
                                        <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                                            <div className="flex items-center gap-2">
                                                <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                                                <span className="text-sm text-green-600 font-semibold">Active Support</span>
                                            </div>
                                            <ArrowRight 
                                                size={20} 
                    ...
                    <div className="text-center mt-16">
                        <div className="inline-block bg-gradient-to-r from-purple-100 to-blue-100 p-8 rounded-3xl border-2 border-black shadow-[8px_8px_0px_#000]">
                            <h3 className="text-2xl font-bold text-black mb-4">Need Specialized Support?</h3>
                            <p className="text-gray-700 mb-6 max-w-md mx-auto">Every industry has unique IT requirements. Let's discuss how we can provide tailored support solutions for your specific business needs.</p>
            ...
            <div className="py-24 bg-white">
                <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                            Get help through your preferred communication method with consistent quality across all channels.
                        </p>
                    </div>
                        ...
                        {supportChannels.map((channel, index) => (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <h3 className="font-semibold text-black mb-1">{channel.name}</h3>
            ...
            <div className="py-24 bg-gray-50 relative overflow-hidden">
                ...
                <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6 relative z-10">
                    <div className="text-center mb-20">
                        ...
                        <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                            A systematic approach ensuring rapid issue resolution and proactive system maintenance for optimal performance.
                        </p>
                    </div>
                    ...
                    <div className="text-center mt-20">
                        <div className="bg-[#dcd4ff] text-black px-8 py-9 rounded-tr-[10px] rounded-bl-[10px] transition-all duration-300 shadow-[8px_8px_0px_#000] border border-black">
                            <h3 className="text-2xl font-bold mb-4">Ready for Reliable IT Support?</h3>
                            <p className="mb-6 text-black">Let's ensure your systems are always running smoothly with our comprehensive support and maintenance services!</p>
            ...
            <div className="py-24 bg-gradient-to-br from-purple-50 to-blue-50">
                <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                            Real results from businesses that transformed their IT operations with our comprehensive support and maintenance services.
                        </p>
                    </div>
                            ...
                            <div key={index} className="group">
                                <div className="bg-white p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-purple-200 hover:-translate-y-2">
                                    ...
                                    <div className="inline-flex items-center gap-2 bg-[#dcd4ff] px-3 py-1 rounded-full mb-4">
                                        ...
                                        <span className="text-sm font-semibold text-black">{testimonial.supportType}</span>
                                    </div>
            ...
            <div className="py-24 bg-white">
                <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                            Experience the advantages of dedicated technical support that keeps your business running smoothly and securely.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <div className="text-center p-6 group hover:bg-purple-50 rounded-2xl transition-colors duration-300">
                            ...
                            <h3 className="text-xl font-bold text-black mb-3">Minimized Downtime</h3>
                            <p className="text-gray-700">Proactive monitoring and rapid response reduce system downtime by up to 95%, keeping your business operations running smoothly.</p>
                        </div>
                        ...
                        <div className="text-center p-6 group hover:bg-purple-50 rounded-2xl transition-colors duration-300">
                            ...
                            <h3 className="text-xl font-bold text-black mb-3">Enhanced Security</h3>
                            <p className="text-gray-700">Regular security updates and monitoring protect against 99% of common cyber threats, safeguarding your valuable business data.</p>
                        </div>
                        ...
                        <div className="text-center p-6 group hover:bg-purple-50 rounded-2xl transition-colors duration-300">
                            ...
                            <h3 className="text-xl font-bold text-black mb-3">Cost Savings</h3>
                            <p className="text-gray-700">Preventive maintenance reduces unexpected repair costs by 60% and extends hardware lifespan, maximizing your IT investment.</p>
                        </div>
                        ...
                        <div className="text-center p-6 group hover:bg-purple-50 rounded-2xl transition-colors duration-300">
                            ...
                            <h3 className="text-xl font-bold text-black mb-3">Expert Team Access</h3>
                            <p className="text-gray-700">Get instant access to certified IT professionals with diverse expertise, eliminating the need for costly in-house IT staff.</p>
                        </div>
                        ...
                        <div className="text-center p-6 group hover:bg-purple-50 rounded-2xl transition-colors duration-300">
                            ...
                            <h3 className="text-xl font-bold text-black mb-3">Performance Optimization</h3>
                            <p className="text-gray-700">Regular system tuning and optimization improve performance by 40%, ensuring your technology supports business growth.</p>
                        </div>
                        ...
                        <div className="text-center p-6 group hover:bg-purple-50 rounded-2xl transition-colors duration-300">
                            ...
                            <h3 className="text-xl font-bold text-black mb-3">Peace of Mind</h3>
                            <p className="text-gray-700">24/7 monitoring and support give you confidence that your systems are protected, letting you focus on core business activities.</p>
                        </div>
                    </div>
                </div>
            </div>
