...
//               <div className="w-20 h-20 bg-gradient-to-br from-purple-400 to-purple-500 rounded-full flex items-center justify-center shadow-xl">
...
//             <span className="font-['Inter'] text-purple-500 font-semibold">Terms & Conditions</span>
//           </div>
//         </div>
//       </div>
...
//           {/* Document Info */}
//           <div className="text-center bg-white rounded-2xl p-8  border-2 border-purple-100 shadow-[10px_10px_0px_rgb(0,0,0,0.8)]" >
...
//           {/* Table of Contents */}
//           <div className="bg-[#DBD2FF] rounded-xl  p-8 border border-gray-200 shadow-[10px_10px_0px_rgb(0,0,0,0.8)]">
...
//                     <span className="font-['Outfit'] text-2xl font-bold text-purple-500 min-w-[48px]">
//                       {String(index + 1).padStart(2, '0')}
//                     </span>
