...
const WebsiteDevelopmentPage = () => {
    ...
    const features = [
        {
            ...
            description: "Tailored solutions built from scratch to match your unique brand identity and business requirements."
        },
        {
    ...
    const processSteps = [
        {
            ...
            description: "We understand your business goals, target audience, and project requirements to create a comprehensive development strategy."
        },
        {
            step: "02",
            title: "Design & Wireframing",
            description: "Creating user-friendly wireframes and stunning visual designs that align with your brand identity."
        },
        {
            step: "03",
            title: "Development & Testing",
            description: "Building your website with clean code, rigorous testing, and ensuring cross-browser compatibility."
        },
        {
            step: "04",
            title: "Launch & Support",
            description: "Seamless deployment to production with ongoing maintenance and technical support."
        }
    ];
    ...
    const testimonials = [
        {
            ...
            quote: "Their team delivered exactly what we needed - a fast, beautiful website that converts visitors into customers.",
            rating: 5
        },
        {
            name: "Michael Chen",
            company: "GreenLeaf Solutions",
            quote: "Professional service from start to finish. Our new website has increased our online presence significantly.",
            rating: 5
        },
        {
            name: "Emily Rodriguez",
            company: "Creative Studio",
            quote: "Outstanding work! They understood our vision and brought it to life perfectly.",
            rating: 5
        }
    ];
                ...
                <div className="w-full lg:w-[85%] relative z-10 flex flex-col lg:flex-row items-center min-h-screen px-4 sm:px-6 py-8">
                    ...
                    <div className="w-full lg:w-[55%] text-center lg:text-left">
                        ...
                        <p className="text-lg sm:text-xl text-gray-700 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                            We design and develop custom websites that not only look great but also perform exceptionally well across all devices and platforms.
                        </p>
                        ...
                        <div className="space-y-8">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700">
                                        Tailored to your brand with unique designs that reflect your business identity and values, from simple brochure sites to complex web applications.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700">
                                        Ensure your website looks perfect and functions flawlessly on all devices, providing an optimal user experience across smartphones, tablets, and desktops.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700">
                                        Built with search engine optimization in mind, featuring clean code, proper meta tags, structured data, and fast loading speeds to improve search rankings.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700">
                                        Optimized for fast loading times and high engagement, using modern techniques like lazy loading, image optimization, and efficient caching strategies.
                                    </p>
                                </div>
                            </div>
                        </div>
  ...
  <img
    ...
    style={{ backgroundColor: tech.color, borderRadius: "50%", padding: "6px" }}
  />
</div>
                            ...
                            {processSteps.map((step, index) => (
                                <div key={index} className={`flex flex-col lg:flex-row items-center gap-8 ${
                                    ...
                                    <div className="hidden lg:flex lg:w-2/12 justify-center">
                                        <div className="relative">
                                            <div className={`w-16 h-16 border-4 border-black shadow-lg flex items-center justify-center text-black font-bold text-xl transition-all duration-500 hover:scale-125 ${
                                                index === 0 ? 'bg-[#dcd4ff]' :
                                                index === 1 ? 'bg-[#dcd4ff]' :
                                                index === 2 ? 'bg-[#dcd4ff]' :
                                                'bg-[#dcd4ff]'
